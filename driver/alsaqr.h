 ...
 */
#define ALSAQR_MMAP_SOC_CTRL      0
#define ALSAQR_MMAP_L2_INTL_0     10
#define ALSAQR_MMAP_L2_CONT_0     11
#define ALSAQR_MMAP_L2_INTL_1     12
#define ALSAQR_MMAP_L2_CONT_1     13
#define ALSAQR_MMAP_SAFETY_ISLAND 100
#define ALSAQR_MMAP_INT_CLUSTER   200
#define ALSAQR_MMAP_SPATZ_CLUSTER 300

/*
 * ALSAQR_CLUSTER_RUN: load binary into L2 (via mmap), then issue this
 ...
 * letter0/letter1 mailbox seam as ALSAQR_OT_XFORM (see
 * alsaqr_mock_ot.h's ALSAQR_OT_CMD_CLUSTER_BOOT).
 *
 ...
 */
struct alsaqr_cluster_run {
	__u32 boot_addr;
	__u32 result;
};

#define ALSAQR_CLUSTER_RUN _IOWR(ALSAQR_MAGIC, 1, struct alsaqr_cluster_run)
